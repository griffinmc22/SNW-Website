  ...
  return (
    <div className=' bg-[#90ADC6]'>
        <div className='container mx-auto'>
            <div className='grid grid-cols-1 lg:grid-cols-2 h-screen max-h-[1000px] w-full z-0 space-x-4 bg-[#90ADC6]'>
                    <div className='px-4'>
                        <img className='hidden lg:block md:scale-100 md:object-cover' src={Mechanic3} ></img>
                        <img className='hidden lg:block md:scale-100 md:my-[-100px]' src={Mechanic1} ></img>
                    </div>
                    {/* content with text */}
                    <div className='pr-4'>
                        <h2 className='! md:py-10 text-2xl md:text-4xl font-bold border-b-4 border-[#FAD02C] text-center'>Services</h2>
